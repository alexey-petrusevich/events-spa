defmodule EventsApp.EventsTest do
  ...
  describe "events" do
    ...
    @valid_attrs %{date: "2010-04-17T14:00:00Z", description: "some description", link: "some link", name: "some name"}
    @update_attrs %{date: "2011-05-18T15:01:01Z", description: "some updated description", link: "some updated link", name: "some updated name"}
    @invalid_attrs %{date: nil, description: nil, link: nil, name: nil}
